...
class HTMLHelper:
    ...
    def getDefaultHTML(self, error = 0):
        html = '''
<html>
<head><title>Sentipy-Twitter sentiment analyzer</title>
...
<body>
    ...
    <div class="yui3-u" id="hd">
        <h2> Sentipy-Twitter Sentiment Analyzer </h2>
    </div>
    <div class="yui3-u" id="bd">
        ...
        <p><input type="text" value="" name="keyword" id="keyword"/><input type="submit" value="Submit" id="sub"/></p>
            ...
            <div id="choice">
                <p>Analyzed by maximum Entropy algorithm and Sentiwordnet</p>
            </div>
        </form>
'''
        if(error == 1):
